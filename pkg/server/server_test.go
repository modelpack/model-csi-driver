...
func TestServer(t *testing.T) {
	...
	service.NewPuller = func(ctx context.Context, pullCfg *config.PullConfig, hook *status.Hook, diskQuotaChecker *service.DiskQuotaChecker, layerCache *service.LayerCache) service.Puller {
		return &mockPuller{
			pullCfg:  pullCfg,
